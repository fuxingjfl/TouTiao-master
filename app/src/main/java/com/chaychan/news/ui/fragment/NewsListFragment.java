...
import com.chaychan.news.ui.activity.VideoPlayActivity;
...
import com.chaychan.news.ui.widget.GridDivider;
...
//    LinearLayout ll_news_list;
    ...
    private boolean isVideoList,isxsVideoList;
    ...
    public void initData() {
        ...
        isxsVideoList=getArguments().getBoolean(Constant.IS_XSVIDEO_LIST,false);
    ...
    public void initListener() {
        if (isVideoList){
            if (isxsVideoList){
                ...
                mRvNews.addItemDecoration(new GridDivider(mActivity));

                mNewsAdapter=new MicroVideoAdapter(R.layout.item_xsvideo,mList);
