...
public class DragRelativeLayout extends RelativeLayout {
    ...
    // 设置接口
    private com.chaychan.news.ui.widget.OnDragListener mListener;
    ...
    // 设置回调
    public DragRelativeLayout setOnoDragListener(com.chaychan.news.ui.widget.OnDragListener listener) {
        mListener = listener;
        return this;
    }
